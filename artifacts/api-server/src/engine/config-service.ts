...
export const config = {
  ...
  // Overlay render fps
  // UI overlay pipe bandwidth at 1080p RGBA: 25fps ≈ 207 MB/s, 15fps ≈ 124 MB/s.
  // 15fps is imperceptible for news tickers / donation alerts and halves pipe I/O pressure.
  bgRendererFps:           2,
  uiRendererFps:           15,
