...
export const BUILTIN_PRESETS: Array<{ name: string; description: string; state: Partial<NewsOverlayState> }> = [
  {
    ...
    state: {
      theme: "CNN",
      ticker: { style: "CNN", direction: "left", motion: "Scroll", speed: 25, paused: false, separator: "   ⚡   " },
  ...
  },
  {
    ...
    state: {
      theme: "Bloomberg",
      ticker: { style: "Bloomberg", direction: "left", motion: "Scroll", speed: 20, paused: false, separator: "  |  " },
  ...
  },
  {
    ...
    state: {
      theme: "BBC",
      ticker: { style: "BBC", direction: "left", motion: "Scroll", speed: 30, paused: false, separator: "  ·  " },
      breakingNews: { active: false, text: "", flashInterval: 800, overridesTicker: false },
  ...
  },
  {
    ...
    state: {
      theme: "Minimal",
      ticker: { style: "Minimal", direction: "left", motion: "Scroll", speed: 35, paused: false, separator: "   ·   " },
      breakingNews: { active: false, text: "", flashInterval: 800, overridesTicker: false },
  ...
  },
  {
    ...
    state: {
      theme: "Election",
      ticker: { style: "Election", direction: "left", motion: "Scroll", speed: 20, paused: false, separator: "  ★  " },
