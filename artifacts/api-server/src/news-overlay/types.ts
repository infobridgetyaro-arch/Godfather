...
export interface TickerConfig {
  ...
  motion: TickerMotion;    // how text moves: Scroll | Stationary | Flap | Typewriter | Wave | Carousel
...
export interface HeadlineConfig {
  text: string;
  subHeadline: string;     // secondary line shown below the main headline
...
export interface NewsOverlayLayout {
  ...
  zIndex: number;
  scale: number;                        // 50–200 (100 = actual size)
}
